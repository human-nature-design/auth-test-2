...
/*
 * Documentation:
 * Checkbox — https://app.subframe.com/eba0e2f569a0/library?component=Checkbox_3816e3b5-c48c-499b-b45e-0777c6972523
 */
    ...
    return (
      ...
      >
        ...
        >
          ...
          {label ? (
            <span className="text-monospace-body font-monospace-body text-default-font group-disabled/3816e3b5:text-subtext-color">
              {label}
            </span>
          ) : null}
        </button>
